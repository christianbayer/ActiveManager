...
CREATE TABLE IF NOT EXISTS `active_manager`.`issues_historics` (
  ...
  `journal_id` INT NULL,
  `old_issue_type_id` INT NULL,
  `old_issue_status_id` INT NULL COMMENT '			',
  `old_issue_priority_id` INT NULL,
  `old_assigned_user_id` INT NULL,
  `old_done_ratio` INT NULL,
  `old_due_date` DATE NULL,
  `old_start_date` DATE NULL,
  `old_end_date` DATE NULL,
  `old_estimated_hours` INT NULL,
  `old_spent_hours` INT NULL,
  `old_parent_issue_id` INT NULL,
  `new_issue_type_id` INT NULL,
  `new_issue_status_id` INT NULL,
  `new_issue_priority_id` INT NULL,
  `new_assigned_user_id` INT NULL,
  `new_done_ratio` INT NULL,
  `new_due_date` DATE NULL,
  `new_start_date` DATE NULL,
  `new_end_date` DATE NULL,
  `new_estimated_hours` INT NULL,
  `new_spent_hours` INT NULL,
  `new_parent_issue_id` INT NULL,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` INT NOT NULL,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_by` INT NOT NULL,
