 ...
 * @author christian
 */
public class AtividadesStatusNovo extends javax.swing.JPanel {
    ...
    public AtividadesStatusNovo(JLabel btnBack, JLabel lblWindow, CardLayout lController, JPanel cardPanel, IssueStatus issueStatus) {
        ...
        lblWindow.setText("NOVO STATUS DE ATIVIDADE");
        ...
        // Edição
        if (issueStatus.getDescription() != null) {
            this.issueStatus = issueStatus;

            // Seta o título da janela
            lblWindow.setText("EDITAR STATUS DE ATIVIDADE");

            // Inicializa os campos
            inpDescription.setText(issueStatus.getDescription());
        }
    }
    ...
    private void validateDescription() {
        ...
        } else if (new IssueStatus().checkDescriptionInUse(description)) {
            if (this.issueStatus == null) {
                setTextFieldError(inpDescription, sepDescription);
                errorsList.add("Este tipo de atividade já está cadastrado!");
            } else if (this.issueStatus.getDescription().equals(description)) {
                setTextFieldNormal(inpDescription, sepDescription);
            } else {
                setTextFieldError(inpDescription, sepDescription);
                errorsList.add("Este tipo de atividade já está cadastrado!");
