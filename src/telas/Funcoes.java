 ...
 * @author christian
 */
public class Funcoes extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblFound.setText("1 funções encontradas:");
        ...
        panRoles.setBackground(new java.awt.Color(254, 254, 254));
        panRoles.setBorder(null);
        panRoles.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        panRoles.add(row1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 740, 30));

        jScrollPane1.setViewportView(panRoles);
    ...
    private void listUser(Role role) {
        JPanel rolePanel = new JPanel();
        rolePanel.setBackground(panRowCount % 2 == 0 ? panColorB : panColorA);
        rolePanel.setLayout(new AbsoluteLayout());
        ...
        lblId.setText(String.valueOf(role.getId()));
        rolePanel.add(lblId, new AbsoluteConstraints(10, 8, -1, -1));

        lblDescription.setFont(new Font("Ubuntu", 0, 12)); // NOI18N
        lblDescription.setText(role.getDescription());
        rolePanel.add(lblDescription, new AbsoluteConstraints(40, 8, -1, -1));
        ...
        btnTrash.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                int res = JOptionPane.showConfirmDialog(null, "Deseja realmente excluir esta função? Esta ação não poderá ser desfeita!");
                if (res == 0) {
        ...
        rolePanel.add(btnTrash, new AbsoluteConstraints(700, 5, -1, -1));
        ...
        rolePanel.add(btnEdit, new AbsoluteConstraints(670, 5, -1, -1));

        panRoles.add(rolePanel, new AbsoluteConstraints(0, panY, 740, 30));
    ...
    private void inicializarLista() {
        ...
        panRoles.removeAll();
        panRoles.updateUI();
        ArrayList<Object> roles = roleDAO.getAll();
        Iterator<Object> iterator = roles.iterator();
        while (iterator.hasNext()) {
            Role role = (Role) iterator.next();
            listUser(role);
        }
        lblFound.setText(roles.size() + " funções encontradas:");
    }
