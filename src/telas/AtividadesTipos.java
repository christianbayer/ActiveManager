 ...
 * @author christian
 */
public class AtividadesTipos extends javax.swing.JPanel {
    ...
    AtividadesTiposNovo atividadesTiposNovo;
    User user;

    /**
     * Creates new form Usuario
     */
    public AtividadesTipos(JLabel btnBack, JLabel lblWindow, CardLayout lController, JPanel cardPanel, User user) {
        initComponents();

        // Seta o título da janela
        lblWindow.setText("TIPOS DE ATIVIDADES");
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        atividadesTiposNovo = new AtividadesTiposNovo(btnBack, lblWindow, layoutController, cardPanel, new IssueType(), user);
        cardPanel.add(atividadesTiposNovo, "atividadesTiposNovo");
        layoutController = ((CardLayout) cardPanel.getLayout());
        layoutController.show(cardPanel, "atividadesTiposNovo");
    ...
    private void listIssueType(IssueType issueType) {
        JPanel issueTypePanel = new JPanel();
        issueTypePanel.setBackground(panRowCount % 2 == 0 ? panColorB : panColorA);
        issueTypePanel.setLayout(new AbsoluteLayout());
        ...
        issueTypePanel.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblId.setFont(new Font("Ubuntu", 0, 12)); // NOI18N
        lblId.setText(String.valueOf(issueType.getId()));
        issueTypePanel.add(lblId, new AbsoluteConstraints(10, 8, -1, -1));

        lblDescription.setFont(new Font("Ubuntu", 0, 12)); // NOI18N
        lblDescription.setText(issueType.getDescription());
        issueTypePanel.add(lblDescription, new AbsoluteConstraints(40, 8, -1, -1));
        ...
        issueTypePanel.add(btnTrash, new AbsoluteConstraints(700, 5, -1, -1));

        btnEdit.setIcon(new ImageIcon(getClass().getResource("/icons/edit.png"))); // NOI18N
        btnEdit.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                atividadesTiposNovo = new AtividadesTiposNovo(btnBack, lblWindow, layoutController, cardPanel, issueType, user);
                cardPanel.add(atividadesTiposNovo, "atividadesTiposNovo");
                layoutController = ((CardLayout) cardPanel.getLayout());
                layoutController.show(cardPanel, "atividadesTiposNovo");
            }
        });
        issueTypePanel.add(btnEdit, new AbsoluteConstraints(670, 5, -1, -1));

        panIssuesTypes.add(issueTypePanel, new AbsoluteConstraints(0, panY, 740, 30));
    ...
    private void inicializarLista() {
        ...
        ArrayList<Object> projectsTypes = issueTypeDAO.getAll();
