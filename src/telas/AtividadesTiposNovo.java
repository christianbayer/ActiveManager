 ...
 * @author christian
 */
public class AtividadesTiposNovo extends javax.swing.JPanel {
    ...
    public AtividadesTiposNovo(JLabel btnBack, JLabel lblWindow, CardLayout lController, JPanel cardPanel, IssueType issueType, User user) {
        ...
        // Edição
        if (issueType.getDescription() != null) {
            ...
            inpDescription.setText(issueType.getDescription());
        }
    }
    ...
    private void validateDescription() {
        ...
        } else if (new IssueType().checkDescriptionInUse(description)) {
            if (this.issueType == null) {
                setTextFieldError(inpDescription, sepDescription);
                errorsList.add("Este tipo de atividade já está cadastrado!");
            } else if (this.issueType.getDescription().equals(description)) {
                setTextFieldNormal(inpDescription, sepDescription);
            } else {
                setTextFieldError(inpDescription, sepDescription);
                errorsList.add("Este tipo de atividade já está cadastrado!");
